...
def test_html_to_markdown():
    """Test the html-to-markdown library"""
    try:
        from html_to_markdown import convert_to_markdown
    except ImportError:
        print("Installing html-to-markdown...")
        import subprocess
        subprocess.run(["python3", "-m", "pip", "install", "html-to-markdown"], check=True)
        from html_to_markdown import convert_to_markdown
    
    # Test HTML with complex table structure
...
<div class="comment"><div class="commtext cBE">I started downloading, I'm eager to test it. I will share my personal experiences. <a href="https://ahmetcadirci.com/2025/gpt-oss/" rel="nofollow">https://ahmetcadirci.com/2025/gpt-oss/</a></div><div class="reply"><p><font size="1"><u><a href="reply?id=44802125&amp;goto=item%3Fid%3D44800746%2344802125" rel="nofollow">reply</a></u></font></p></div></div></td></tr></tbody></table></td></tr></tbody></table>'''
    ...
    print("Testing html-to-markdown library:")
    
    # Test with different configurations
    configs = [
        {"extract_metadata": False},
        # {"extract_metadata": False, "strip": ["table", "tbody", "tr", "td", "th", "thead"]},
        {"extract_metadata": False, "convert_as_inline": False},
    ]
    ...
    for i, config in enumerate(configs, 1):
        ...
        try:
            tt = time()
            result = convert_to_markdown(test_html, strip_newlines=True, parser="lxml", **config)
            print(f"Time taken: {time() - tt:.4f} seconds")
            print("\nFormatted:")
            print(result)
